...
// SEO: Static sitemap and robots.txt
// Note: These files are now served statically from public/ directory
// Generated by: php artisan sitemap:generate
// Scheduled update: Daily at 02:00 via scheduler

// Fallback routes if static files don't exist (for development)
...
Route::get('/robots.txt', function () {
    ...
    // Fallback to dynamic generation
    return app(App\Http\Controllers\SitemapController::class)->robots();
})->name('robots');

// Keep legacy dynamic routes for manual access/debugging
Route::get('/sitemap-dynamic.xml', [App\Http\Controllers\SitemapController::class, 'index'])->name('sitemap.dynamic');
...
Route::get('/robots-dynamic.txt', [App\Http\Controllers\SitemapController::class, 'robots'])->name('robots.dynamic');
