...
@php
    ...
    // Skip rendering if no breadcrumbs or only home
    if (empty($breadcrumbs) || (!$showHome && count($breadcrumbs) <= 1)) {
        return;
    }
    
    $structuredData = $showStructuredData ? $breadcrumbService->getStructuredData() : null;
@endphp
