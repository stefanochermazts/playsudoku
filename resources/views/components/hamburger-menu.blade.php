                 ...
                 <div class="space-y-1">
                     ...
                     <div class="flex items-center space-x-2 px-2 py-1.5">
                         ...
                         <div class="flex space-x-1">
                             <a href="{{ str_replace('/' . app()->getLocale() . '/', '/it/', request()->url()) }}" 
                                @click="menuOpen = false"
                     ...
                     <!-- Privacy Settings -->
                     <a href="{{ route('localized.privacy.index', ['locale' => app()->getLocale()]) }}" 
                        class="flex items-center space-x-2 px-2 py-1.5 rounded-md text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
                        @click="menuOpen = false">
                         <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                         </svg>
                         <span>{{ __('app.nav.privacy') ?? 'Privacy' }}</span>
                     </a>
                     
                     <!-- Theme Toggle -->
                     <button @click="toggleTheme(); menuOpen = false" 
                             class="flex items-center space-x-2 w-full px-2 py-1.5 rounded-md text-sm text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors">
                         <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                         </svg>
                         <span>{{ __('app.nav.theme') ?? 'Tema' }}</span>
                     </button>
                 </div>
             </div>
