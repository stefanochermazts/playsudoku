...
<div class="relative" x-data="{ menuOpen: false, isDark: document.documentElement.classList.contains('dark') }">
	...
	<div x-show="menuOpen" 
		 ...
		 <!-- Grid Layout: 6 groups in horizontal layout -->
		 <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 p-4">
		     ...
		     <!-- Group 4: Articles -->
		     <div class="space-y-3">
		         <h3 class="text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wide border-b border-neutral-200 dark:border-neutral-600 pb-2">{{ __('app.nav.articles') }}</h3>
		         <div class="space-y-1">
		             ...
		             <a href="{{ route('localized.articles.category', ['locale' => app()->getLocale(), 'category' => 'techniques']) }}" 
		                ...
		                @click="menuOpen = false">
		                 ...
		                 <span>{{ __('app.nav.techniques') }}</span>
		             </a>
		         </div>
		     </div>
