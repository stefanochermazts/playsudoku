    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                @if($currentWeek->copy()->addWeeks(12) <= now()->startOfWeek())
                                        ...
                                        @foreach($challenge->attempts->take(5) as $index => $attempt)
                                            <div class="flex flex-col items-center">
                                                <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium
                                                    ...
                                                    @elseif($index === 2) bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300
                                                    @else bg-neutral-100 text-neutral-600 dark:bg-neutral-700 dark:text-neutral-400
                                                    @endif">
                                                    {{ $index + 1 }}
                                                </div>
