<x-site-layout class="overflow-x-hidden">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white">
                        {{ __('app.clubs.create_title') }}
                    </h1>
                    <p class="mt-2 text-neutral-600 dark:text-neutral-400">
                        {{ __('app.clubs.create_subtitle') }}
                    </p>
                </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form method="POST" action="{{ route('localized.clubs.store', ['locale' => app()->getLocale()]) }}" class="space-y-8">
            @csrf
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="{{ __('app.clubs.description_placeholder') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="visibility" 
                            ...
                            <option value="invite_only" {{ old('visibility') === 'invite_only' ? 'selected' : '' }}>
